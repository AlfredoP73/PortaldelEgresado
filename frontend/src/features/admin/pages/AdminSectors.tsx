  ...
  return (
    <div className="space-y-6">
      <div className="page-header flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h2 className="page-title text-[var(--text-main)]">Sectores Empresariales</h2>
          <p className="text-sm mt-1 text-ink-secondary">Categoriza las industrias de las empresas aliadas.</p>
        </div>
      ...
      <div className="card overflow-hidden">
        {loading ? (
          ...
          <div className="p-12 text-center flex flex-col items-center justify-center">
            <Tags className="w-12 h-12 mb-4 text-ink-tertiary opacity-50" />
            <h3 className="text-lg font-bold text-ink">No hay sectores</h3>
            <p className="mt-1 text-ink-secondary">Comienza agregando el primer sector empresarial.</p>
          </div>
        ) : (
          <>
            <table className="w-full text-left text-sm">
              <thead className="bg-[var(--bg-muted)] border-b border-[var(--border-color)]">
                <tr>
                  ...
                  <th className="px-6 py-4 w-full font-bold uppercase text-[11px] tracking-wider text-ink-secondary">Nombre del Sector</th>
